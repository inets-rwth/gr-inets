...
This final tagged stream is then modulated. Finally, the stream tags are adjusted using the \textit{Tagged Stream Mux Length Tag} block.% before the tagged symbol stream is scaled and handed off to the SDR hardware. 
